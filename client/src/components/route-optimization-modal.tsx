...
export function RouteOptimizationModal({
  ...
  const [prioritizeTrip, setPrioritizeTrip] = useState(false);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-hidden flex flex-col bg-gradient-to-br from-background/95 via-background/98 to-background dark:from-black/95 dark:via-black/98 dark:to-black border-2 border-blue-500/20 dark:border-blue-400/20 transition-smooth" data-testid="modal-route-optimization">
        <DialogHeader className="flex-shrink-0">
          <DialogTitle className="text-2xl font-semibold flex items-center gap-2 text-blue-600 dark:text-blue-400">
          ...
          <div className="space-y-6 mt-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg border">
                <div className="flex-1">
                  <Label htmlFor="prioritize-trip" className="font-medium cursor-pointer">
                    Prioritize Trip Grouping
                  </Label>
                  <p className="text-sm text-muted-foreground mt-1">
                    Group locations with the same trip type together
                  </p>
                </div>
                <Switch
                  id="prioritize-trip"
                  checked={prioritizeTrip}
                  onCheckedChange={setPrioritizeTrip}
                  data-testid="switch-prioritize-trip"
                />
              </div>
            </div>
